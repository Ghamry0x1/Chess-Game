...
function Pawn(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/4/45/Chess_plt45.svg' : 'https://upload.wikimedia.org/wikipedia/commons/c/c7/Chess_pdt45.svg';
...
function Bishop(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/b/b1/Chess_blt45.svg' : 'https://upload.wikimedia.org/wikipedia/commons/9/98/Chess_bdt45.svg';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Knight(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/d/d9/Chess_clt45.svg' : 'https://upload.wikimedia.org/wikipedia/commons/4/43/Chess_adt45.svg';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Rook(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Chess_tile_rl-whitebg.svg' : 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Chess_tile_rd.svg';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Queen(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/1/15/Chess_qlt45.svg' : 'https://upload.wikimedia.org/wikipedia/commons/4/47/Chess_qdt45.svg';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function King(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'https://upload.wikimedia.org/wikipedia/commons/4/42/Chess_klt45.svg' : 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Chess_kdt45.svg';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function init() {
    ...
    var boardPosition = BoardPosition.BLACK_ON_TOP;
...
function GameState(canvas, boardPosition, cellSize, currentMoveStatus) {
    ...
    canvas.addEventListener('mouseup', function(e) {
        ...
        if (myState.dragging) {
            ...
            if (validMove) {
                myState.changeCurrentMove();
            } else { // in case the move is invalid, return the selected piece to the initial position
    ...
    this.selectionColor = 'rgba(255, 255, 0, 0.7)';
