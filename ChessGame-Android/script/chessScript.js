...
function Pawn(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/pawn_w.png' : 'img/pawn_b.png';
...
function Bishop(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/bishop_w.png' : 'img/bishop_b.png';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Knight(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/knight_w.png' : 'img/knight_b.png';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Rook(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/rook_w.png' : 'img/rook_b.png';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function Queen(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/queen_w.png' : 'img/queen_b.png';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
...
function King(row, col, pieceColor, pieceSize) {
    ...
    var img = pieceColor == PieceColorEnum.WHITE ? 'img/king_w.png' : 'img/king_b.png';
    Piece.call(this, row, col, img, pieceColor, pieceSize);
}
